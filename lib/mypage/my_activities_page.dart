...
class MyActivitiesPage extends StatefulWidget {
  final bool showOnlyShared; // 추가된 파라미터
...
class _MyActivitiesPageState extends State<MyActivitiesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.showOnlyShared) {
      // home_page.dart 에서 호출될 때: shareYn이 Y인 데이터만 보여줍니다.
      query = FirebaseFirestore.instance
          .collection('photos')
          .where('shareYn', isEqualTo: 'Y');
    } else {
      // mypage.dart 에서 호출될 때: 해당 이메일의 모든 데이터를 보여줍니다.
      query = FirebaseFirestore.instance
          .collection('photos')
    ...
    return Scaffold(
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => MyDetailPage(
                                ...
                                showBottomTabBar: !widget
                                    .showOnlyShared, // showOnlyShared가 true이면 탭 바를 숨김
                              ),
                            ),
                          );
                        },
      ...
      floatingActionButton: !widget.showOnlyShared // 조건부 표시
