...
class MyDetailPage extends StatefulWidget {
  final Map<String, dynamic> photoData;
  final VoidCallback? onDelete; // onDelete 콜백 추가
  final bool showBottomTabBar; // 새로운 파라미터
...
class _MyDetailPageState extends State<MyDetailPage> {
            ...
            TextButton(
              onPressed: () async {
                ...
                try {
                  ...
                  Navigator.of(context).pop(); // 로딩 indicator 제거
                }
              },
              child: const Text('삭제'),
            ),
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment:
                      MainAxisAlignment.spaceEvenly, // 간격을 균등하게 분배
                  children: <Widget>[
                    Expanded(
                      child: InkWell(
                        onTap: () {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: widget.showBottomTabBar // 조건부 표시
          ? BottomNavigationBar(
              backgroundColor: Colors.white,
              selectedItemColor: Colors.indigo,
              unselectedItemColor: Colors.grey,
              ...
              onTap: (index) {
                if (index == 0) {
                  ...
                  _showShareBottomSheet(context); // BottomSheet 표시
                }
              },
            )
          : null, // 탭 바를 숨김
